FNC_SetHostage = {
	...
	if (hasInterface) then {
		_unit addAction ["<t color='#FBB829'>Rescue Hostage</t>", "[[(_this select 0), (_this select 1)], 'FNC_RescueHostage', false] call BIS_fnc_MP;", nil, 6, true, true, "", "(_target distance _this) < 2 && !(_target getVariable ['FW_Rescued', false]);"];
	};
